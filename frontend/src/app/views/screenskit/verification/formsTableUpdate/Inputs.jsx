...
export default function Inputs({
    ...
    const fishermanSelectedDefault =
        teamSelected?.fisheries[index] !== undefined
            ? { ...teamSelected?.fisheries[index] }
            : "";
    const nameFishermanCompact =
        teamSelected?.fisheries[index] !== undefined
            ? `${fishermanSelectedDefault?.fisherman.id} - ${fishermanSelectedDefault?.fisherman.name} (${fishermanSelectedDefault?.fisherman.cpf})`
            : "";
    ...
    const dataFihsermenOfTeamCompact = fihsermenOfTeam?.fishermen.map(
        (fisherman) => {
            return {
                id: fisherman.id,
    ...
    function submitUpdate() {
        ...
        const promiseUpdate = instance.put(
            `/fishing/${dataInputs.fishing_id}`,
            dataUpdate
        );
        ...
        <>
            ...
            >
                ...
                <Autocomplete
                    ...
                    renderInput={(params) => (
                        <TextField
                            {...params}
                            label="Pescador"
                            placeholder="selecione o pescador"
                        />
                    )}
                ...
                <TextField
                    ...
                    onChange={(e) =>
                        handleOnChange(
                            mask(unMask(e.target.value), MASK_INPUT_LENGTH),
                            "size"
                        )
                    }
                    label="Tamanho"
